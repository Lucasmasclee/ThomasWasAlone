...
namespace Bundos.WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        [SerializeField] float splashInfluence = 0.005f;
        [SerializeField] float waveHeight = .25f;

        [Header("Constant Waves Settings")]
        [SerializeField] bool hasConstantWaves = true;
        [SerializeField] float waveAmplitude = 1f;
        [SerializeField] float waveSpeed = 1f;
        [SerializeField] int waveStep = 1;

        [Header("Spring Settings")]
        [SerializeField] int numSprings = 10;
        [SerializeField] float spacing = 1f;
        [SerializeField] float springConstant = 0.05f;
        [SerializeField] float springDamping = 0.025f;
